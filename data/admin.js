...
import {checkNumberFormat, checkNameFormat, checkEmailAddress, validPassword, validRole}  from "../helper.js";
...
const createAdmin = async (
  ...
  if (!insertInfo.acknowledged || !insertInfo.insertedId) throw 'Could not add an admin';
